...
@Injectable()
export class FractionService extends BaseService {
  private url: string = 'https://localhost:44333/api/Generic/Fraction';
  ...
  public async getFractionList(): Promise<CodeNameBaseModel[]> {
    try {
      ...
      console.error(error);
      this.alertService.errorShow('Не удалось получить список фракций.');
      return [];
    }
  }
}
